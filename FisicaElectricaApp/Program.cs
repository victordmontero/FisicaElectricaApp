...
namespace FisicaElectricaApp
{
    class Program
    {
            ...
            while (isRunning)
            {
                ...
                switch (opc)
                {
                    ...
                    case 2: //Calcular Fuerzas
                        Console.Write($"Elija una carga [0-{cargas.Count - 1}]: ");
        ...
        private static void CalcularCampoElectrico(Vector punto)
        {
            ...
            Console.WriteLine($"Fuerza Resultante: {campoResultante.Length().ToString("E")}");
        ...
        private static void CalcularFuerzaResultante(int index)
        {
            ...
            Console.WriteLine($"Fuerza Resultante: {fuerzaTotal.Length().ToString("E")}");
        ...
        private static List<Particula> GetCharges()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Ponga la Carga 0 para salir");
                Console.Write("Carga: ");
        ...
        {
            Console.WriteLine("1-Entrar cargas");
            Console.WriteLine("2-Calcular Fuerzas");
